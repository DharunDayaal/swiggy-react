...
const TopResturantCard = ({ restaurant, discount, rating, price, deliveryTime, cusine, location, image }) => {
  return (
    <>
      <div className="card-slider">
          <div className="img-list mt-5 mb-5">
              <div className="card">
                  <div>
                      <div className="img-container">
                          <img className="card-img-top " src={image} alt="burger-king"/>
                      </div>
                  </div>
                  <div className="card-body">
                      <h6>{discount} <span>&#x20B9;</span>{price}</h6>
                      <h4>{restaurant}</h4>
                      <div className="d-flex flex-row ">
                          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" role="img" aria-hidden="true" strokeColor="rgba(2, 6, 12, 0.92)" fillColor="rgba(2, 6, 12, 0.92)">
                              ...
                              <defs>
                              <linearGradient id="StoreRating20_svg__paint0_linear_32982_71567" x1="10" y1="1" x2="10" y2="19" gradientUsers="userSpaceOnUse">
